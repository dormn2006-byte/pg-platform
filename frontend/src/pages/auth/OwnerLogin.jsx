...
const OwnerLogin = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#070b17] text-white">
      ...
      <div className="absolute right-[-120px] top-[200px] h-96 w-96 rounded-full bg-violet-500/20 blur-3xl"></div>
      <div className="absolute bottom-[-150px] left-[20%] h-96 w-96 rounded-full bg-pink-500/20 blur-3xl"></div>
        ...
        <div className="grid w-full max-w-7xl items-center gap-6 lg:gap-10 lg:grid-cols-2">
          ...
          <div className="hidden lg:block">
            ...
            <p className="mt-6 max-w-md text-lg leading-8 text-gray-300">
              Access your owner dashboard, manage listings, rooms, bookings and student inquiries from one place.
            </p>
